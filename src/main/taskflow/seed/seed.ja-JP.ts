...
/** Bundled guide project (ja-JP), generated from scripts/guide-source/guide.data.json. */
export const GUIDE_SEED_JA_JP: TaskFlowData = {
  "version": 1,
  "projects": [
    {
      "id": "project_guide",
      ...
      "pinnedAt": "2026-08-30T15:28:02.689Z",
      "sortOrder": 120,
      "viewport": {
        "x": 1108.96899176291,
        "y": -467.4136920434581,
  ...
  "cards": [
    {
      ...
      "title": "カードを追加",
      "markdown": "- [ ] Shift+A でカードを追加\n- [ ] キャンバスの空白をダブルクリックでカードを追加\n- [ ] 緑の接続点からキャンバスの空白までドラッグしてカードを追加\n- [ ] カードを選択した状態で Tab キーでカードを追加",
      "x": -879.7247205532775,
      "y": -380.6994217315473,
      "collapsed": false,
      "completed": false,
      "createdAt": "2026-08-30T15:28:02.689Z",
      "updatedAt": "2026-08-30T15:28:02.689Z"
    },
    {
      "id": "card_44ae7d91-8797-42df-8920-bb3bde16a09b",
      "projectId": "project_guide",
      "title": "カードのすばやい移動",
      "markdown": "- [ ] Ctrl+左右キーで選択カードをすばやく移動",
      "x": -885.6037809990153,
    ...
    },
    {
      ...
      "projectId": "project_guide",
      "title": "接続",
      "markdown": "- [ ] カードAの接続点をカードBの接続点までドラッグして接続\n- [ ] Ctrl+右クリックで接続を切断\n- [ ] Ctrl+X でカードCをDとEの間から切り離す\n- [ ] カードCを接続線までドラッグして再接続\n- [ ] C キーを押すとクイック接続モード。左クリックでカードをすばやく接続",
      "x": -897.5501963780996,
      "y": 642.0172301910197,
      "collapsed": false,
      "completed": false,
    ...
    },
    {
      ...
      "projectId": "project_guide",
      "title": "完了と固定",
      "markdown": "- [ ] カード上部の丸いボタンをチェックするとタスクをタイマーに固定\n- [ ] 三角ボタンをチェックするとタスク完了。タイマーでアニメーションが再生",
    ...
    },
    {
      ...
      "projectId": "project_guide",
      "title": "ショートカット",
      "markdown": "- [ ] ショートカットでタイマーの表示/非表示と開始を操作（初期値は Alt+P）\n- [ ] へたをクリックして常に手前に表示を切替\n- [ ] Ctrl+1/2/3… でタスクを切替\n- [ ] T キーで左サイドバーの表示を切替\n- [ ] N キーで右サイドバーの表示を切替",
      "x": -1591.832972719495,
    ...
    },
    {
      ...
      "projectId": "project_guide",
      "title": "添付メモ",
      "markdown": "- [ ] カードGを選択した状態（編集外）で Enter を押すと添付メモを追加\n- [ ] メモはテキストとお絵かきの2つのモードを切替可能\n- [ ] お絵かきモードでは、左長押しがペン、右長押しが消しゴム",
      "x": -889.9319982205853,
    ...
    },
    {
      ...
      "projectId": "project_guide",
      "title": "メモ",
      "markdown": "Ctrl+Shift+A でキャンバスにメモを追加\nタスクカードにドラッグすると添付メモとして掛けられます",
      "x": -888.0188410333291,
      "y": 1857.10965493433,
      "collapsed": false,
      "completed": false,
    ...
    },
    {
      ...
      "projectId": "project_guide",
      "title": "キャンバス",
      "markdown": "- [ ] 中ボタンのスクロールでズーム、押しながらドラッグでパン\n- [ ] Ctrl+中ボタンでキャンバスを横にスクロール\n- [ ] 上記2つの操作は設定で入れ替え可能",
      "x": -1596.6541032186278,
      "y": -374.450592580487,
      "collapsed": false,
      "completed": false,
      "createdAt": "2026-08-30T15:28:02.689Z",
    ...
    },
    {
      ...
      "projectId": "project_guide",
      "title": "グループ",
      "markdown": "- [ ] Ctrl+G で選択中のカードをグループ化\n- [ ] Ctrl+Shift+G で選択中のカードのグループ化を解除\n- [ ] グループ外のカードをグループ内にドラッグすると追加\n- [ ] グループの空白を右クリックでメニューを表示",
      "x": -886.8743942241407,
